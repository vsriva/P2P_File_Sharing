...
1. Go to p2pserver folder and open the terminal, run server.py to setup the server 
2. Go to p2pclient1 and p2pclient2 folder and open terminal, run client.py to setup the clients 
